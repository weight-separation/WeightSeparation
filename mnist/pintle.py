...
import_name = dir_name + '.mnist_data'
...
def v_num_of_neurons_per_layer():
	return [[28, 28, 1], [13, 13, 16], [5, 5, 32], [1, 1, 48], [256], [128], [10]]
...
def v_train_input_variables():
	data = __import__(import_name).mnist_data
...
def v_execute(graph, sess, input_tensors, input_variables, output_tensors=None,
	...
	if ground_truth is not None:
		...
		print("mnist inference accuracy: %f" % test_accuracy)
