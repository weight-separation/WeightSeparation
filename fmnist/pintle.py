...
import_name = dir_name + '.fmnist_data'
...
def v_num_of_neurons_per_layer():
	return [[28, 28, 1], [13, 13, 24], [5, 5, 32], [1, 1, 52], [256], [128], [10]]
...
def v_train_input_variables():
	data = __import__(import_name).fmnist_data
...
def v_execute(graph, sess, input_tensors, input_variables, output_tensors=None,
	...
	if ground_truth is not None:
		...
		print("fmnist inference accuracy: %f" % test_accuracy)
