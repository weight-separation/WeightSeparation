...
import_name = dir_name + '.GTSRB_data'
...
def v_num_of_neurons_per_layer():
	return [[32, 32, 1], [15, 15, 16], [6, 6, 32], [2, 2, 52], [128], [128], [43]]
...
def v_train_input_variables():
	data = __import__(import_name).GTSRB_data
...
def v_execute(graph, sess, input_tensors, input_variables, output_tensors=None,
	...
	if ground_truth is not None:
		...
		print("gtsrb inference accuracy: %f" % test_accuracy)
